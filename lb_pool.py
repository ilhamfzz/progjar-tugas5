...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.18.0.5', 6001))
        self.servers.append(('172.18.0.5', 6002))
        self.servers.append(('172.18.0.5', 6003))
        self.servers.append(('172.18.0.5', 6004))
        self.current = 0
...
class Server:
    def __init__(self, portnumber: int):
        ...
        self.socket.bind(('172.18.0.5', portnumber))
